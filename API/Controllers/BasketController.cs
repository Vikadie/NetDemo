...
namespace API.Controllers
{
    public class BasketController : BaseApiController
    {
        ...
        private Basket CreateBasket()
        {
            ...
            var buyerId = User.Identity?.Name;// check if there is a User.Identity to get his name 
        ...
        {
            return User.Identity?.Name ?? Request.Cookies["buyerId"]; // ?? means if a user is identified retunrs it, else if (User.Identity.Name == null) return Request.Cookies["buyerId"] for the anonymous basket
        }
    }
}